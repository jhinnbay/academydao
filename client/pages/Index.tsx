  ...
  return (
    <div className="min-h-screen bg-azura-black text-azura-white font-cartograph">
      <div className="max-w-md mx-auto min-h-screen relative">
        ...
        <div className="absolute top-24 right-4 w-6 h-6">
          <svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="pt-24 px-4 pb-4">
          ...
          <div className="border border-azura-gray-border bg-azura-black mb-4">
            ...
            <div className="p-4">
              {/* Sync Account Card */}
              <div className="mb-5">
                <div className="flex items-center justify-between h-24 px-6 border-2 border-azura-gray-light rounded-xl bg-azura-black">
              ...
              <div className="mb-5">
                <div className="flex items-center justify-between h-24 px-6 border-2 border-azura-gray-light rounded-xl bg-azura-black/25">
                  <div className="flex items-center gap-4">
