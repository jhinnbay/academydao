      ...
      <div className="max-w-md mx-auto min-h-screen relative sm:max-w-lg md:max-w-xl lg:max-w-2xl xl:max-w-3xl z-10">
        ...
        <div className="px-6 pb-4 sm:px-8 md:px-12 lg:px-16 xl:px-20" style={{ paddingTop: '156px' }}>
          ...
          <div
            ...
            className={`voltage-container backdrop-blur-md min-h-[400px] p-6 shadow-2xl rounded overflow-hidden scroll-snap-start ${
              isGenerating || isTyping || isN8nLoading ? "active" : ""
            }`}
            style={{
          ...
          >
            {/* Voltage Effect SVG */}
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 234.6 61.3" preserveAspectRatio="none" xmlSpace="preserve">
